...
# Presentation functions class
class IO:
    """
    A collection of presentation layer functions that manage user input and output

    ChangeLog: (Who, When, What)
    SSetta,6.13.2026,Created Class
    """
    pass
    ...
    def output_menu(menu: str):
        ...
        ChangeLog: (Who, When, What)
        SSetta,6.13.2026,Created function
    ...
    def input_employee_data(employee_data: list, employee_type: object):
        ...
        :param employee_type: A reference to data_class.Employee used to create a Employee object
        ...
        try:
            # Input the data
            employee_object = employee_type() # construct a new student object due to the reference.
